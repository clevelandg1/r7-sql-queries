...
FROM fact_remediation(25, 'assets DESC, riskscore DESC') AS fr
INNER JOIN dim_solution ds ON fr.solution_id = ds.solution_id
ORDER BY fr.assets DESC, fr.riskscore DESC;