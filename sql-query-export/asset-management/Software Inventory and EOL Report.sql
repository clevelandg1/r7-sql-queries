-- Software Inventory and EOL Report
...
SELECT
    ...
    (
        ...
        AND (
            -- Associate vulnerabilities with software (simplified, may need customization)
    ...
    COALESCE(
        (
            ...
            WHERE ta.asset_id = da.asset_id
            AND t.tag_type = 'OWNER'
            LIMIT 1
        ),
        'Unassigned'
    ) AS "Owner",
